...
Requires an external PostgreSQL database. The chart does not bundle a database. See [backup and restore](https://github.com/alvarorg14/openlicensd/blob/main/docs/backup-restore.md) for operator-owned backup procedures.
